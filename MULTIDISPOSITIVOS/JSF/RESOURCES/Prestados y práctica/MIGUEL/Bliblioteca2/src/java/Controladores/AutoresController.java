...
public class AutoresController implements Serializable {
    ...
    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItemsAutores(ejbFacade.autoresOrdenados(), true);
    }
    ...
    @FacesConverter(forClass = Autores.class, value="autoresConverter")
    ...
    public int calcularEdad(Date fnac){
        ...
        Calendar fechaNacimento=Calendar.getInstance();
        fechaNacimento.setTime(fnac);

        int anyos=fechaActual.get(Calendar.YEAR)-fechaNacimento.get(Calendar.YEAR);
        int meses=fechaActual.get(Calendar.MONTH)-fechaNacimento.get(Calendar.MONTH);
        int dias=fechaActual.get(Calendar.DATE)-fechaNacimento.get(Calendar.DATE);
    ...
    public void obtenerAutoresPremios(){
        lista = ejbFacade.AutoresPremio(premio);
    }
}
