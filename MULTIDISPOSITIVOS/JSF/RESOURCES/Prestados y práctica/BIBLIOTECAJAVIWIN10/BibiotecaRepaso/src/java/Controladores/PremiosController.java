...
public class PremiosController implements Serializable {
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItemsPremios(ejbFacade.findAll(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItemsPremios(ejbFacade.findAll(), true);
    }
    
    public SelectItem[] getItemsAvailableSelectOneDeLibros() {
        return JsfUtil.getSelectItemsPremios(ejbFacade.findAllDeLibros(), true);
    }
    
    public SelectItem[] getItemsAvailableSelectManyDeLibros() {
        return JsfUtil.getSelectItemsPremios(ejbFacade.findAllDeLibros(), false);
    }
    public Premios getPremios(java.lang.Integer id) {
        return ejbFacade.find(id);
    }

    @FacesConverter(forClass = Premios.class, value="premiosConverter")
